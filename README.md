...
- **Dev Proxy Integration**: Test API failures, rate limiting, and offline development ([see testing guide](docs/TESTING.md#4-api-resilience-testing-with-dev-proxy))
